...
const Checkout = ({ setOrderFormValue }) => {
    ...
    const [formValues, setFormValues] = useState({ firstname: "", lastname: "", email: "", phonenumber: "", streetaddress: "", country: "", postal: "", city: "", State: "", card: "", expiration: "", cvv: "" })
    const [formErrors, setFormErrors] = useState({});
    const navigate = useNavigate();

    useEffect(() => {
        document.title = "Checkout | Lady Luxe";
    }, []);
    ...
    const validateForm = (values, step = "payment") => {
        ...
        if (step === "address") {
            ...
            else if (numberRegex.test(values.State)) {
                errors.State = "Please enter a valid State";
            }
    ...
    const submitForm = (e) => {
        ...
        if (Object.keys(validateForm(formValues)).length > 0) {
            ...
            setFormValues({ firstname: "", lastname: "", email: "", phonenumber: "", streetaddress: "", country: "", postal: "", city: "", State: "", card: "", expiration: "", cvv: "" })
